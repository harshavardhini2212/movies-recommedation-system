...
class App extends React.Component {
  ...
  getPopularMovies() {
    const url = `https://api.themoviedb.org/3/movie/popular?api_key=dbc45a0482fbcd1fc97dcd1fecee761e`;
  ...
  searchMovie(query) {
    const url = `https://api.themoviedb.org/3/search/movie?query=${query}&api_key=dbc45a0482fbcd1fc97dcd1fecee761e`;
